        ...
        <div id="container"> 
            ...
            <div id="wrapper">
                ...
                <div class="container">
                    <div class="row" id="printpage">
                        <div class="col-md-3">
                            <div class="panel">
                                <div class="panel-heading text-center">
                                    <div class="text-center"><h6 name="title_bank"> {{ $temp_bank }} </h4></div>
                                    <div class="text-center"><h6><u> For Credit of Collection A/C No.{{ $ac_no }}</u></h4></div>
                                    <div class="text-center"><h6><b> Semester: {{ $temp_session }} </b></h4></div>
                                    <br>
                                    <div class="row text-center">
                                        <div class="col-md-4">Challan No: {{ $temp_id }}</div>
                                        <div class="col-md-4"></div>
                                        <div class="col-md-4 "><u>Due Date: {{ $temp_feedue }}</u></div>
                                    </div>
                                    <br>
                                ...
                                <div class="panel-body">
                                    ...
                                    <p style="font-size:9px;">Registration No: <u> {{Auth::user()->reg}} </u></p>
                                    <p style="font-size:9px;">Student Name: <u> {{Auth::user()->name}} </u></p>
                                    <p style="font-size:9px;">Father Name: <u> {{Auth::user()->father_name}} </u></p>
                                    <p style="font-size:9px;">Faculity: <u> {{Auth::user()->faculity}} </u></p>
                                    <p style="font-size:9px;">Department: <u> {{Auth::user()->department}} </u></p>
                                    <p style="font-size:9px;">Program: <u> {{Auth::user()->program}} </u></p>
                                    <p style="font-size:9px;">Batch: <u> {{Auth::user()->batch}} </u></p>

                                    <table class="table table-striped table-bordered">
                                       <thead>
                                           <tr>
                                                <th for="code" class="text-center">Code</th>
                                                <th for="cname" class="text-center">Courses To Be Studied</th>
                                       ...
                                       @if(count($coursereg) > 0)
                                        @foreach($coursereg->all() as $course)
                                            <tr>
                                                <td class="text-center" name="code">{{ $course->code }}</td>
                                    ...
                                    <table class="table table-striped table-bordered">
                                       <thead>
                                           <tr>
                                                <th for="part" class="text-center">Particulars</th>
                                                <th for="am" class="text-center">Amount</th>
                                           </tr>
                                       </thead>
                                       <tbody>
                            
                                            <tr>
                                                <td name="part">Tuition Fee</td>
                                                <td name="am" class="text-center">{{ $temp_unifee }}</td>
                                            <tr>
                                            <tr>
                                                <td name="part" >Registration Fee</td>
                                                <td name="am" class="text-center">{{ $temp_regfee }}</td>
                                            <tr>

                                            <tr>
                                                <td name="part">Others</td>
                                                <td name="am" class="text-center">{{ $temp_others }}</td>
                                            <tr>
                                          
                                            <tr>
                                                <td name="part"><b>Total Amount:</b></td>
                                                <td name="am" class="text-center"><b>{{ $total_amount }}</b></td>
                                            <tr>
                                       </tbody>
                                    </table>
                                    <br>

                                    <p style="font-size:9px;">&nbsp;&nbsp;Officer(FeeSection) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   Cashier(Bank)</p>

                                </div>
                                <div class="panel-footer">
                                    <div class="text-center">
                                        <p style="font-size:16px;"><b><u> Student Copy</u></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="panel">
                                ...
                                <div class="panel-footer">
                                    <div class="text-center">
                                        <p style="font-size:16px;"><b><u> Academics Copy</u></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="panel">
                                ...
                                <div class="panel-footer">
                                    <div class="text-center">
                                        <p style="font-size:16px;"><b><u> Bank Copy</u></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="panel">
                                ...
                                <div class="panel-footer">
                                    <div class="text-center">
                                        <p style="font-size:16px;"><b><u> Fee Section Copy</u></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel">
                        <div class="row text-center">
                            <p style="font-size:16px;" class="text text-success"><u>Note:</u>&nbsp;Print this form and goto bank for payment before due date.</p>
                        </div>
                        <div class="text-center">
                            <p class="text text-danger"><b><u> Last date of fees submission is {{ $temp_feedue }}</u></p>
                        </div>
                    </div>

                    <div class="row">
                        <a onclick="printDiv()" value="print" class="btn btn-primary btn-small pull-right">Pay Full Fee</a>
                        <a href="{{ url('/installment',$total_amount) }}" class="btn btn-primary btn-small">Apply for Installment</a>
                    </div>
