        ...
        <div id="container"> 
            ...
            <div id="wrapper">
                ...
                <div id="page-content-wrapper" class="stretch-full-height animated-med-delay fadeInRight">
                    ...
                    <div class="row">
                        <legend class="panel panel-info text-center"> Edit Your Profile</legend>
                    </div>

                    <div class="container">
                            <div class="row">
                                <div class="col-md-4 text-center">
                                    <img src="{{asset('storage/upload/'.Auth::user()->image)}}" alt="upload image" style=" max-width:200px; height:200px;"/>
                                </div>
                                <div class="col-md-4">
                                    <p class="control-label" style="font-size:18px;">Name: <b>{{Auth::user()->name}}</b></p>
                                    <p class="control-label" style="font-size:18px;">Father Name: <b>{{Auth::user()->father_name}}</b></p>
                                    <p class="control-label" style="font-size:18px;">Registration No: <b>{{Auth::user()->reg}}</b></p>
                                    <p class="control-label" style="font-size:18px;">Faculity: <b>{{Auth::user()->faculity}}</b></p>
                                    <p class="control-label" style="font-size:18px;">Department: <b>{{Auth::user()->department}}</b></p>
                                    <p class="control-label" style="font-size:18px;">Program: <b>{{Auth::user()->program}}</b></p>
                                    <p class="control-label" style="font-size:18px;">Batch: <b>{{Auth::user()->batch}}</b></p>
                                </div>
                                <div class="col-md-4">
                                    <p class="control-label" style="font-size:18px;">Semester: <b>{{Auth::user()->semester}}</b></p>
                                    <p class="control-label" style="font-size:18px;">Email: <b>{{Auth::user()->email}}</b></p>
                                    <p class="control-label" style="font-size:18px;">Date of Birth: <b>{{Auth::user()->dob}}</b></p>
                                    <p class="control-label" style="font-size:18px;">Gender: <b>{{Auth::user()->gender}}</b></p>
                                    <p class="control-label" style="font-size:18px;">Nationality: <b>{{Auth::user()->nationality}}</b></p>
                                    <p class="control-label" style="font-size:18px;">CNIC: <b>{{Auth::user()->cnic}}</b></p>
                                    <p class="control-label" style="font-size:18px;">Domicile: <b>{{Auth::user()->domicile}}</b></p>
                                </div>
                            </div>
                    </div>
                    ...
                    <div class="container">
                        ...
                        <form class="form-horizontal" method="POST" action="{{ url('/editedbystud')  }}">
                            {{csrf_field()}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                        <div class="col-lg-5 col-lg-offset-2">
                                            <button type="submit" class="btn btn-primary pull-right" name="btnsubmit">Update</button>
                                        </div>
                                    </div>
