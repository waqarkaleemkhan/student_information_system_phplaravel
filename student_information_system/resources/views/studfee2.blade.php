                ...
                <div id="sidebar-wrapper" class="stretch-full-height">
                    <ul class="sidebar-nav">
                        ...
                        <li class="nav-header" id="uiMenu"> 
                            ...
                            <ul class="nav nav-list collapse submenu" id="uiMenus">
                                <li><a href="#" style="color: #ffffff;" class="active">Fee Details</a></li>
                            </ul>
                        </li>
                            ...
                            <div class="center-panel col-sm-6 col-sm-offset-3 col-xs-offset-1">
                                <div class="text-center animated fadeInDown">
                                    <ul class="list-unstyled">
                                        ...
                                        <li>
                                            <h2 class="text-center">Please join your courses here <a href="{{ url('/courses2') }}" class="text-transparent" style="text-decoration:underline">Course Registration</a> and then back to fee section.<br>Thanks!</h2>
                                    </li>
                                    </ul>
                                </div>
                            </div>
