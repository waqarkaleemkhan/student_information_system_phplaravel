                        ...
                        <div class="col-md-12">
                            <div class="panel">
                                ...
                                <div class="panel-heading">
                                    ...
                                    <div class="text-center"><h4><u> (EXAMINATION BRANCH) </u></h4></div>
                                    <br>
                                    <div class="row text-center">
                                            <h4><u>ROLL NO SLIP FOR {{ $temp_session }}</u></h4>
                                    </div>
                                    <br>
                                    <div class="row">
                                        <div class="col-md-2"></div>
                                        <div class="col-md-6"><b><u>Roll / Registraion# {{ Auth::user()->reg }}</u></b></div>
                                ...
                                <div class="col-md-2"></div>
                                   <div class="col-md-6">
                                        <p style="font-size:18px;">Admit Sy./Aa: <u> {{ Auth::user()->name }} </u></p>
                                        <p style="font-size:18px;">Son/Daughter of <u> {{ Auth::user()->father_name }} </u></p>
                                        <p style="font-size:18px;">of the Faculty/Institute/School  <u> {{ Auth::user()->faculity }} </u></p>
                                        <p style="font-size:18px;">for the (Name of Class)  <u> {{ Auth::user()->program }} </u></p>
                                        <p style="font-size:18px;">Batch:  <u> {{ Auth::user()->batch }} </u></p>
                                        <p style="font-size:18px;">Examination to be held in  <u> {{ $temp_examdate }} </u></p> 
                                        <br>
                                        
                                        <div class="text-center"><h4><u> REGISTERED COURSES TO BE EXAMINED IN {{ $temp_session }}</u></h4></div>                                            
                                       ...
                                       <thead>
                                           <tr>
                                                ...
                                                <th for="cname" class="text-center">Title of Course</th>
                               ...
                               <br><br><br>
                                    ...
                                    <div class="row">
                                         ...
                                         <div class="col-md-4 text-center">
                                             <p style="font-size:18px;"><h5 style="text-decoration-line: overline;"> DEPUTY DIRECTOR <br>(EXAMINATION)</h5></p>
                                         </div>
                                         <div class="col-md-2"></div>
                                         <div class="col-md-4 text-center">
                                         <p><h5 style="text-decoration-line: overline;" class="pull-right"> Signature of student</h5></p>
                                         </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <h4><b>NOTE:</b></h4>
                                    <p style="font-size:16px;"><h5> i) Bring this slip and your University Identity Card in the Exam Hall.</h5></p>
                                    <p style="font-size:16px;"><h5> ii) Possession of a Cell Phone in the Examination Hall will be treated as an offence under unfair mean rules.</h5></p>
                                    <p style="font-size:16px;"><h5> iii) Your Registration No will act as Roll No.</h5></p>
                                    <p style="font-size:16px;"><h5> iv) All Roll No Slips are issued provisionally; therefore appearance in the exams doesnot confer any right to student to claim result of these courses.</h5></p>
                                    <p style="font-size:16px;"><h5> i) Students should not appear in the exams if having short of attendance (less than 75% ) in any course(s) and result shall be cancelled in case of their appearance in exams.</h5></p>
