                            ...
                            <div class="center-panel col-sm-6 col-sm-offset-3 col-xs-offset-1">
                                <div class="text-center animated fadeInDown">
                                    <ul class="list-unstyled">
                                        <li class="text-transparent padding-bottom animated shake"><div class="huge-text">Courses</div></li>
                                        <li>
                                            <h2 class="text-center">Course registration has closed. Please print your <a href="{{ url('/studfee') }}" class="text-transparent" style="text-decoration:underline">fees</a> and pay before due date!</h2>
                                    </li>
                                    </ul>
                                </div>
                            </div>
