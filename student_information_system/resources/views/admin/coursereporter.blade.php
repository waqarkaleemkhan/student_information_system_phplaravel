            ...
            <div id="wrapper">
                ...
                <br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <legend><span><i class="icon-file"></i> &nbsp;</span>Course Reporter</legend>
                        </div>
                        <div class="col-md-3">
                        </div>
                    </div>
                    ...
                    <form class="form-horizontal" method="POST" action="{{ url('admin/coursereportered') }}">
                            {{csrf_field()}}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="c_name" class="col-lg-3 control-label">Course Name:</label>
                                            <div class="col-lg-9">
