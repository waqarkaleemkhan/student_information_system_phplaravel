            ...
            <div id="wrapper">
                    ...
                    <ul class="sidebar-nav">
                        ...
                        <li class="nav-header" id="uiMenu"> 
                            ...
                            <ul class="nav nav-list collapse submenu" id="uiMenus">
                                <li><a href="{{ url('admin/home') }}" style="color: #ffffff;" class="active">Student Profiles</a></li>
                ...
                <div class="container">
                    <div class="row">
                            ...
                            <form class="form-horizontal" method="POST" action="{{ url('/edit',array($profiles->id) )  }}" enctype="multipart/form-data">
                            {{csrf_field()}}
                                ...
                                <div class="col-md-6">
                                    ...
                                    <label for="reg" class="col-lg-3 control-label">Registration#</label>
                                        <div class="col-lg-9">
                                        <input type = "text" value="<?php if(isset($profiles->reg)): echo $profiles->reg; endif; ?>" name="reg" class = "form-control" placeholder="Enter registration# here" required>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group"> 
                                    <label for="name" class="col-lg-3 control-label">Name:</label>
                                        <div class="col-lg-9">
                                            <input type = "text"  value="<?php if(isset($profiles->name)): echo $profiles->name; endif; ?>" name="name" class = "form-control" placeholder="Enter fullname" required>
                                        </div>
                                    </div>
                                    ...
                                    <label for="father_name" class="col-lg-3 control-label">Father Name:</label>
                                        <div class="col-lg-9">
                                            <input type = "text"  value="<?php if(isset($profiles->father_name)): echo $profiles->father_name; endif; ?>" name="father_name" class = "form-control" placeholder="Enter father name" required>
                                        </div>
                                    </div>
                                    <br>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="email" class="form-control"  value="<?php if(isset($profiles->email)): echo $profiles->email; endif; ?>" name ="email" id="email" placeholder="a@gmail.com" required>   
                                        </div>
                                    </div>
                                    <br>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="date"  value="<?php if(isset($profiles->dob)): echo $profiles->dob; endif; ?>" class="form-control" name ="dob" id="dob" placeholder="01-04-1995" required>   
                                        </div>
                                    </div>
                                    <br>
                                        ...
                                        <label for="gender" class="col-lg-3 control-label">Gender:</label>
                                            <div class="col-lg-9">
                                                <select class="form-control" name="gender" id="gender" required>
                                                        <option  value="<?php if(isset($profiles->gender)): echo $profiles->gender; endif; ?>"><?php if(isset($profiles->gender)): echo $profiles->gender; endif; ?></option>
                                    ...
                                    <label for="nationality" class="col-lg-3 control-label">Nationality:</label>
                                        ...
                                        <select class="form-control" name="nationality" id="nationality" required>
                                                <option value="<?php if(isset($profiles->nationality)): echo $profiles->nationality; endif; ?>"><?php if(isset($profiles->nationality)): echo $profiles->nationality; endif; ?></option>
                                    ...
                                    <label for="cnic" class="col-lg-3 control-label">CNIC:</label>
                                        <div class="col-lg-9">
                                            <input type="number" name="cnic" value="<?php if(isset($profiles->cnic)): echo $profiles->cnic; endif; ?>" class = "form-control" placeholder="Enter cnic (without dashes)" required>
                                        </div>
                                    </div>
                                    <br>
                                    ...
                                    <label for="domicile" class="col-lg-3 control-label">Domicile:</label>
                                        ...
                                        <select class="form-control" name="domicile" id="domicile" required>
                                                <option value="<?php if(isset($profiles->domicile)): echo $profiles->domicile; endif; ?>"><?php if(isset($profiles->domicile)): echo $profiles->domicile; endif; ?></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <select class="form-control" name="faculity" id="facultySel" onchange="ChangeFaculty()" required>
                                                    <option  value="<?php if(isset($profiles->faculity)): echo $profiles->faculity; endif; ?>" ><?php if(isset($profiles->faculity)): echo $profiles->faculity; endif; ?></option>
                                            </select>
                                        </div>
                                    </div>
                                    <br>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-3"></div>
                                        ...
                                        <img id="imgg"  src="{{asset('storage/upload/'.$profiles->image)}}" alt="upload image" style=" max-width:100px; height:100px;"/>
									        
                                            <input type='file' name="image"  onchange="readURL(this);" style=" " value="<?php  public_path().'/storage/upload/'.$profiles->image; ?>"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9"> 
                                            <select class="form-control" name="department" id="departmentSel" onchange="ChangeDepartment()" required>
                                                <option value="<?php if(isset($profiles->department)): echo $profiles->department; endif; ?>"><?php if(isset($profiles->department)): echo $profiles->department; endif; ?></option>
                                            </select>
                                        </div>
                                    </div>
                                    <br>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9"> 
                                            <select class="form-control" name="program" id="programSel" required>
                                                <option value="<?php if(isset($profiles->program)): echo $profiles->program; endif; ?>"><?php if(isset($profiles->program)): echo $profiles->program; endif; ?></option>
                                            </select>
                                        </div>
                                    </div>
                                    <br>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <select class="form-control" name="batch" id="batch" required>
                                                    <option value="<?php if(isset($profiles->batch)): echo $profiles->batch; endif; ?>"><?php if(isset($profiles->batch)): echo $profiles->batch; endif; ?></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <select class="form-control" name="semester" id="semester" required>
                                                    <option value="<?php if(isset($profiles->semester)): echo $profiles->semester; endif; ?>" ><?php if(isset($profiles->semester)): echo $profiles->semester; endif; ?></option>
                                    ...
                                    <label for="address" class="col-lg-3 control-label">Address:</label>
                                        <div class="col-lg-9">
                                            <input type = "text" value="<?php if(isset($profiles->address)): echo $profiles->address; endif; ?>" name="address" class = "form-control" placeholder="Enter Address" required>
                                        </div>
                                    </div>
                                    <br>
                                    ...
                                    <label for="city" class="col-lg-3 control-label">City:</label>
                                        <div class="col-lg-9">
                                            <input type = "text" value="<?php if(isset($profiles->city)): echo $profiles->city; endif; ?>" name="city" class = "form-control" placeholder="Enter City" required>
                                        </div>
                                    </div>
                                    <br>
                                    ...
                                    <label for="phone" class="col-lg-3 control-label">Phone#:</label>
                                        <div class="col-lg-9">
                                            <input type = "number" value="<?php if(isset($profiles->phone)): echo $profiles->phone; endif; ?>" name="phone" class = "form-control" placeholder="Enter Phone#" required>
                                        </div>
                                    </div>
