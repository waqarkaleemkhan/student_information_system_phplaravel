            ...
            <div id="wrapper">
                    ...
                    <ul class="sidebar-nav">
                        ...
                        <li> 
                            ...
                            <ul class="nav nav-list collapse submenu" id="uiMenus">
                                ...
                                <li><a href="#" class="active" style="color: #ffffff;">Add Session</a></li>
                            </ul>
                        </li>
                ...
                <div id="page-content-wrapper" class="stretch-full-height animated-med-delay fadeInRight">
                    ...
                    <div class="container">
                        ...
                        <form class="form-horizontal" method="POST" action="{{ url('admin/addedsession') }}">
                            {{csrf_field()}}
                            <legend class="text-center">Create a new Session</legend>
                                ...
                                <br>
                                    <div class="panel panel-info">
                                        <div class="panel-heading">
                                            <div class="pull-left"><h4>Session</h4></div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label for="session_name"><h4>Create Session:</h4></label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label for="course_duedate"><h4>Course Registration Due Date:</h4></label>
                                            </div>
                                        </div>

                                        <div class="row">
                                            <div class="col-md-10">
                                                <input type="date" name="course_duedate" class="form-control" required>
                                            </div>
                                            <div class="col-md-2"></div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label for="fee_duedate"><h4>Fees Payment Due Date:</h4></label>
                                            </div>
                                        </div>

                                        <div class="row">
                                            <div class="col-md-10">
                                                <input type="date" name="fee_duedate" class="form-control" required>
                                            </div>
                                            <div class="col-md-2"></div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label for="instal_duedate"><h4> 2nd Installment Due Date: (In Case of installment)</h4></label>
                                            </div>
                                        </div>

                                        <div class="row">
                                            <div class="col-md-10">
                                                <input type="date" name="instal_duedate" class="form-control" required>
                                            </div>
                                            <div class="col-md-2"></div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                                <label for="exam_date"><h4>Examination to be held in:</h4></label>
                                            </div>
                                        </div>
