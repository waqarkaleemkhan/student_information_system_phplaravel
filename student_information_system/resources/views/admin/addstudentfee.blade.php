            ...
            <div id="wrapper">
                    ...
                    <ul class="sidebar-nav">
                        ...
                        <li> 
                            ...
                            <ul class="nav nav-list collapse submenu" id="uiMenus">
                                ...
                                <li><a href="#" style="color: #ffffff;" class="active">Add Student Fees</a></li>
                            </ul>
                        </li>
                ...
                <div id="page-content-wrapper" class="stretch-full-height animated-med-delay fadeInRight">
                    ...
                    <div class="container">
                        ...
                        <form class="form-horizontal" method="POST" action="{{ url('admin/addedstudentfee') }}">
                            {{csrf_field()}}
                            <legend class="text-center">Add Student Fees</legend>
                                ...
                                <br>
                                    <div class="panel panel-info">
                                        <div class="panel-heading">
                                            <div class="pull-left"><h4>Student Fees</h4></div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label for="name"><h4>Student Name:</h4></label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label for="reg"><h4>Registration #:</h4></label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label for="total_fee"><h4>Total Fees:</h4></label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label for="paid"><h4>Paid:</h4></label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <button type="submit" class="btn btn-primary pull-right" name="btnsubmit">Add</button>
                                            </div>
                                            <div class="col-md-4"></div>
                                        </div>
