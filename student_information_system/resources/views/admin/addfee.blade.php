            ...
            <div id="wrapper">
                    ...
                    <ul class="sidebar-nav">
                        ...
                        <li> 
                            ...
                            <ul class="nav nav-list collapse submenu" id="uiMenus">
                                ...
                                <li><a href="#" style="color: #ffffff;" class="active">Add Fees</a></li>
                            </ul>
                        </li>
                ...
                <div id="page-content-wrapper" class="stretch-full-height animated-med-delay fadeInRight">
                    ...
                    <div class="container">
                        ...
                        <form class="form-horizontal" method="POST" action="{{ url('admin/addedfee') }}">
                            {{csrf_field()}}
                            <legend class="text-center">Create a new Fee Schema</legend>
                             ...
                             <div class="col-md-6"></div>
                                ...
                                <br>
                                    <div class="panel panel-info">
                                        ...
                                        <div class="row">
                                            <div class="col-md-10">
                                                <input type="number" name="fch" class="form-control" required>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-10">
                                                <input type="number" name="rf" class="form-control" required>
                                            </div>
                                            <div class="col-md-2"></div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-10">
                                                <input type="number" name="oth" class="form-control" required>
                                            </div>
                                            <div class="col-md-2"></div>
                                        </div>
