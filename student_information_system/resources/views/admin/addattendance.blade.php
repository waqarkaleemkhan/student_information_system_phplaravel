            ...
            <div id="wrapper">
                ...
                <div id="page-content-wrapper" class="stretch-full-height animated-med-delay fadeInRight">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <form class="form-horizontal" method="POST" action="{{ url('admin/addedattendance') }}">
                                {{csrf_field()}}
                                <legend class="text-center">Add new Attendance</legend>
                                    ...
                                    @endif
                                        <div class="panel panel-info">
                                            <div class="panel-heading">
                                                <div class="pull-left"><h4>Add Student Attendance</h4></div>
                                            ...
                                            <div class="row">
                                            <div class="col-md-12">
                                                <label for="attend_perc"><h4>Attendance:</h4></label>
                                            </div>
                                        </div>

                                        <div class="row">
                                            <div class="col-md-10">
                                                <select class="form-control" name="attend_perc" required>
                                                        <option value="" selected="selected">-Attendance Status-</option>
