            ...
            <div id="wrapper">
                ...
                <div id="page-content-wrapper" class="stretch-full-height animated-med-delay fadeInRight">
                    ...
                    <div class="container">
                        ...
                        <form class="form-horizontal" method="POST" action="{{ url('admin/edittedfee', array($fees->id)) }}">
                            {{csrf_field()}}
                            <legend class="text-center">Update Fee Schema</legend>
                                ...
                                <br>
                                    <div class="panel panel-info">
                                        <div class="panel-heading">
                                            <div class="pull-left"><h4>Fee</h4></div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label for="fch"><h4>Fees/Credit Hours:</h4></label>
                                            </div>
                                        </div>

                                        <div class="row">
                                            <div class="col-md-10">
                                                <input type="number" name="fch" value="<?php if(isset($fees->ch_fee)): echo $fees->ch_fee; endif; ?>" class="form-control" required>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label for="rf"><h4>Registration Fee:</h4></label>
                                            </div>
                                        </div>

                                        <div class="row">
                                            <div class="col-md-10">
                                                <input type="number" name="rf" value="<?php if(isset($fees->reg_fee)): echo $fees->reg_fee; endif; ?>" class="form-control" required>
                                            </div>
                                            <div class="col-md-2"></div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label for="oth"><h4>Others:</h4></label>
                                            </div>
                                        </div>

                                        <div class="row">
                                            <div class="col-md-10">
                                                <input type="number" name="oth" value="<?php if(isset($fees->others)): echo $fees->others; endif; ?>" class="form-control" required>
                                            </div>
                                            <div class="col-md-2"></div>
                                        </div>
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                @if(count($sessions) > 0)
                                                    @foreach($sessions->all() as $session)
                                                        <option value="<?php if(isset($fees->session_name)): echo $fees->session_name; endif;  ?>" selected="selected"><?php if(isset($fees->session_name)): echo $fees->session_name; endif; $session->session_name; ?></option>
                                                    @endforeach
                                                @endif
                                                </select>
                                            </div>
