        ...
        <div id="container"> 
            ...
            <div id="wrapper">
                ...
                <div class="container">
                    ...
                    <div class="row">
                            <div class="col-md-4">
                            <legend><span><i class="icon-user"></i></span> Student Results </legend>
                            </div>
                            <div class="col-md-4">
                            </div>
                            <div class="col-md-4">
                            <form method="POST" action="{{ url('/searchresultname') }}">
                            {{csrf_field()}}
                            ...
                            @if(count($at) > 0)
                                @foreach($at->all() as $a)
                                    <tr class="success">
                                        ...
                                        <td name="reg">{{ $a->reg }}</td>
                                        <td name="action">
                                            <a href='{{ url("admin/viewresults/{$a->id}") }}' class="label label-success">View</a>
                                            <a href='{{ url("admin/addresults/{$a->id}") }}' class="label label-primary">Add</a>
                                        </td>
                                    </tr>
                                @endforeach
                            @endif
