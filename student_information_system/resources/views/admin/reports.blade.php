            ...
            <div id="wrapper">
                ...
                <div id="sidebar-wrapper" class="stretch-full-height">
                    <ul class="sidebar-nav">
                        ...
                        <li>
                            <a href="#" class="active-title" style="color: #ffffff;">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <legend><span><i class="icon-file"></i> &nbsp;</span> Reports Generator</legend>
                        </div>
                        <div class="col-md-3">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="panel panel-info-solid">
                                <div class="panel-heading">
                                    <div class="pull-left"><h4><i class="icon-euro"></i> Fees Reporter</h4></div>
                                    <div class="clearfix"></div>
                                </div>
                                <div id="collapseTwelve" class="text-center panel-body panel-collapse collapse in">
                                   
                                    
                                   <a class="btn btn-success btn-lg" href="{{ url('admin/feereport') }}">Fees Report</a>
                        ...
                        <div class="col-md-4">
                            <div class="panel panel-success-solid">
                                <div class="panel-heading">
                                    <div class="pull-left"><h4><i class="icon-book"></i> Course Reporter</h4></div>
                                    <div class="clearfix"></div>
                                </div>
                                <div id="collapseTwelve" class="text-center panel-body panel-collapse collapse in">
                                   
                                    
                                   <a class="btn btn-danger btn-lg" href="{{ url('admin/coursereport') }}">Courses Report</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="panel panel-danger-solid">
                                <div class="panel-heading">
                                    <div class="pull-left"><h4><i class="icon-check"></i> Results Reporter</h4></div>
                                    <div class="clearfix"></div>
                                </div>
                                <div id="collapseTwelve" class="text-center panel-body panel-collapse collapse in">
                                   
                                    
                                   <a class="btn btn-primary btn-lg" href="{{ url('admin/resultreport') }}">Result Report</a>
