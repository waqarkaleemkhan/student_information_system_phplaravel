            ...
            <div id="wrapper">
                ...
                <div class="container">
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-4">
                            <legend><span><i class="icon-user"></i></span> Student Course Reports </legend>
                            </div>
                            <div class="col-md-4">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                        <p class="control-label" style="font-size:16px;"> Course Name: <b>{{ $data['c_name'] }}</b> </p>
                        </div>
                        <div class="col-md-4">
                        <p class="control-label" style="font-size:16px;"> Sort By: <b>{{ $data['sort'] }} (registration#)</b> </p>
                        </div>
                        <div class="col-md-4">
                        <p class="control-label" style="font-size:16px;"> Total No of Students: <b>{{ count($studlist) }}</b> </p>
                        </div>
                    </div>
                    ...
                    <br>
                        ...
                        <tbody>
                        @foreach($studlist as $studcourses2)
                            
                            <tr class="warning">
                                <td name="reg">{{ $studcourses2['reg'] }}</td>
                                <td name="name">{{ $studcourses2['name'] }}</td>
                                <td name="action">
                                    <a href='{{ url("admin/readcourses/{$studcourses2["id"]}") }}' class="label label-primary">View Courses</a>
                                </td>
