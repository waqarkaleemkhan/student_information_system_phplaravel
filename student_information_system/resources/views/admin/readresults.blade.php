            ...
            <div id="wrapper">
                ...
                <div class="container">
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-4">
                            <legend><span><i class="icon-user"></i></span> Student Result Details </legend>
                            </div>
                            <div class="col-md-4">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                        <p class="control-label" style="font-size:16px;"> Name: <b>{{ $p->name }}</b> </p>
                        </div>
                        <div class="col-md-4">
                        <p class="control-label" style="font-size:16px;"> Registration#: <b>{{ $p->reg }}</b> </p>
                        </div>
                        <div class="col-md-4">
                        <p class="control-label" style="font-size:16px;"> Batch: <b>{{ $p->batch }}</b> </p>
                        </div>
                    </div>

                    <div class="row">
                        <div class="col-md-4">
                        <p class="control-label" style="font-size:16px;"> Semester: <b>{{ $p->semester }}</b> </p>
                        </div>
                        <div class="col-md-4">
                        <p class="control-label" style="font-size:16px;"> Faculity: <b>{{ $p->faculity }}</b> </p>
                        </div>
                        <div class="col-md-4">
                        <p class="control-label" style="font-size:16px;"> Department: <b>{{ $p->department }}</b> </p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                        <p class="control-label" style="font-size:16px;"> Program: <b>{{ $p->program }}</b> </p>
                        </div>
                        <div class="col-md-4">
                        </div>
                    </div>
                    ...
                    <br>
                        ...
                        <thead>
                            <tr>
                                <th for="code">Code</th>
                                <th for="ct">Course Title</th>
                                <th for="cr">Credit Hours</th>
                                <th for="marks">Marks</th>
                        ...
                        @foreach($results as $c)
                                    ...
                                    <tr class="success">
                                        ...
                                        <td name="ct">{{ $c->course_name }}</td>
                                        <td name="cr">{{ $c->cr_hrs }}</td>
                                        <td for="marks">{{ $c->marks }}</td>
                                        <td for="grade"> {{ $c->grade }} </td>
                                    </tr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <p class="control-label" style="font-size:18px;">CGPA: <b> <u> {{ $w->cgpa }} </u> </b> </p>
                            </div>
                            <div class="col-md-3">
                                <p class="control-label" style="font-size:18px;">Percentage: <b> <u> {{ $w->marks_perc }} </u> </b> </p>
                            </div>
                            <div class="col-md-3">
                                <p class="control-label" style="font-size:18px;">Credit Hours Attempted: <b> <u> {{ $w->nocha }} </u> </b> </p>
                            </div>
                            <div class="col-md-3">
