        ...
        <div id="container"> 
            ...
            <div id="wrapper">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <form class="form-horizontal" method="POST" action="{{ url('admin/edittedcourse',array($courses->course_id)) }}">
                            {{csrf_field()}}
                            <legend class="text-center">Update Course</legend>
                                ...
                                <div class="col-md-6">
                                    <div class="panel panel-info">
                                        <div class="panel-heading">
                                            <div class="pull-left"><h4>Update</h4></div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label for="code"><h4>Course Code:</h4></label>
                                            </div>
                                        </div>

                                        <div class="row">
                                            <div class="col-md-10">
                                                <input type="text" name="code" value="<?php if(isset($courses->code)): echo $courses->code; endif; ?>" class="form-control" required>
                                            </div>
                                        ...
                                        <br>
                                         ...
                                         <div class="row">
                                            <div class="col-md-12">
                                                <label for="course_title"><h4>Course Title:</h4></label>
                                            </div>
                                        </div>

                                        <div class="row">
                                            <div class="col-md-10">
                                                <input type="text" value="<?php if(isset($courses->course_title)): echo $courses->course_title; endif; ?>" name="course_title" class="form-control" required>
                                            </div>
                                            <div class="col-md-2"></div>
                                        </div>
                                        ...
                                        <br> 
                                         ...
                                         <div class="row">
                                            <div class="col-md-12">
                                                <label for="cr_hrs"><h4>Credit Hours:</h4></label>
                                            </div>
                                        </div>

                                        <div class="row">
                                            <div class="col-md-10">
                                                <input type="number" value="<?php if(isset($courses->cr_hrs)): echo $courses->cr_hrs; endif; ?>" name="cr_hrs" class="form-control" required>
                                            </div>
                                            <div class="col-md-2"></div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label for="faculity"><h4>Faculity:</h4></label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label for="program"><h4>Program:</h4></label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label for="session_name"><h4>Session:</h4></label>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                @if(count($sessions) > 0)
                                                    @foreach($sessions->all() as $session)
                                                        <option value="{{ $session->session_name }}" selected="selected">{{ $session->session_name }}</option>
                                                    @endforeach
                                                @endif
                                                </select>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label for="semester_id"><h4>Semester:</h4></label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-10">
                                                <select class="form-control" name="semester_id" id="semester" required>
                                                        <option value="<?php if(isset($courses->semester_id)): echo $courses->semester_id; endif; ?>" selected=""><?php if(isset($courses->semester_id)): echo $courses->semester_id; endif; ?></option>
