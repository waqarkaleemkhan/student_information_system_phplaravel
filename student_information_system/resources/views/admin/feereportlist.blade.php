            ...
            <div id="wrapper">
                ...
                <div id="sidebar-wrapper" class="stretch-full-height">
                    <ul class="sidebar-nav">
                        ...
                        <li>
                            <a href="{{ url('admin/reports') }}" class="active-title" style="color: #ffffff;">
                ...
                <div class="container">
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-4">
                            <legend><span><i class="icon-user"></i></span> Student Fees Reports </legend>
                            </div>
                            <div class="col-md-4">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                        <p class="control-label" style="font-size:16px;"> Faculity: <b>{{ $data['faculity'] }}</b> </p>
                        </div>
                        <div class="col-md-4">
                        <p class="control-label" style="font-size:16px;"> Department: <b>{{ $data['department'] }}</b> </p>
                        </div>
                        <div class="col-md-4">
                        <p class="control-label" style="font-size:16px;"> Program: <b>{{ $data['program'] }}</b> </p>
                        </div>
                    </div>

                    <div class="row">
                        <div class="col-md-4">
                        <p class="control-label" style="font-size:16px;"> Gender: <b>{{ $data['gender'] }}</b> </p>
                        </div>
                        <div class="col-md-4">
                        <p class="control-label" style="font-size:16px;"> Batch: <b>{{ $data['batch'] }}</b> </p>
                        </div>
                        <div class="col-md-4">
                        <p class="control-label" style="font-size:16px;"> Semester: <b>{{ $data['semester'] }}</b> </p>
                        </div>
                    </div>
                    ...
                    <br>
                        ...
                        <thead>
                            <tr>
                                <th for="name">Name</th>
                                <th for="reg">Reg</th>
                                <th for="doj">Date of Joining</th>
                                <th for="total_fee">Total</th>
                                <th for="paid">Paid</th>
                                <th for="remain">Remaining</th>
                            </tr>
                        </thead>
                        <tbody>
                        @foreach($studfee as $studfee2)
                            
                                    <tr class="success">
                                        <td name="name">{{ $studfee2['name'] }}</td>
                                        <td name="reg">{{ $studfee2['reg'] }}</td>
                                        <td name="doj">{{ $studfee2['doj'] }}</td>
                                        <td name="total_fee">{{ $studfee2['total_fee'] }}</td>
                                        <td name="paid">{{ $studfee2['paid'] }}</td>
                                        <td name="remain">{{ $studfee2['remain'] }}</td>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                            <p class="control-label" style="font-size:18px;">Total No of Students: <b> <u> {{ count($studfee) }} </u> </b> </p>
                            </div>
                            <div class="col-md-3">
                                
                                <p class="control-label" style="font-size:18px;">Total Fees: <b> <u> {{ $data['total_fees'] }} </u> </b> </p> 
                             
                            </div>
                            <div class="col-md-3">
                                <p class="control-label" style="font-size:18px;">Total Payments: <b> <u> {{ $data['total_paids'] }} </u> </b> </p>
                            </div>
                            <div class="col-md-3">
                            
                            <p class="control-label" style="font-size:18px;">Overall Remainings: <b> <u> {{  $data['total_remains'] }} </u> </b> </p>
