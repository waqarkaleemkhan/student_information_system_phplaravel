        ...
        <div id="container"> 
            ...
            <div id="wrapper">
                    ...
                    <ul class="sidebar-nav">
                        ...
                        <li class="nav-header" id="uiMenu"> 
                            ...
                            <ul class="nav nav-list collapse submenu" id="uiMenus">
                                <li><a href="{{ url('admin/home') }}" class="active" style="color: #ffffff;">Student Profiles</a></li>
                ...
                <div class="panel panel-info">
                    <legend class="text-center"> Student Details</legend>
                </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-body panel-collapse collapse in">
                        <div class="row">
                        <div class="col-md-4">
                                <img src="{{asset('storage/upload/'.$profiles->image)}}" alt="upload image" style=" max-width:200px; height:200px;"/>
                            </div>
                            
                            <div class="col-md-4">
                                <p class="control-label" style="font-size:18px;">Reg# <b> {{ $profiles->reg }}</b> </p>
                                <p class="control-label" style="font-size:18px;">Name: <b> {{ $profiles->name }} </b></p>
                                <p class="control-label" style="font-size:18px;">Father Name: <b> {{ $profiles->father_name }} </b></p>
                                <p class="control-label" style="font-size:18px;">Email: <b> {{ $profiles->email }} </b></p>
                                <p class="control-label" style="font-size:18px;">Date of Birth: <b> {{ $profiles->dob }} </b></p>
                                <p class="control-label" style="font-size:18px;">Gender: <b> {{ $profiles->gender }} </b></p>
                                <p class="control-label" style="font-size:18px;">Nationality: <b> {{ $profiles->nationality }} </b></p>
                                <p class="control-label" style="font-size:18px;">Cnic: <b> {{ $profiles->cnic }} </b></p>
                                <p class="control-label" style="font-size:18px;">Domicile:<b> {{ $profiles->domicile }} </b></p>
                            </div>

                            <div class="col-md-4">
                                
                                <p class="control-label" style="font-size:18px;">Faculity: <b> {{ $profiles->faculity }} </b></p>
                                <p class="control-label" style="font-size:18px;">Department: <b> {{ $profiles->department }} </b></p>
                                <p class="control-label" style="font-size:18px;">Program: <b> {{ $profiles->program }} </b></p>
                                <p class="control-label" style="font-size:18px;">Batch: <b> {{ $profiles->batch }} </b></p>
                                <p class="control-label" style="font-size:18px;">Semester: <b> {{ $profiles->semester }} </b></p>
                                <p class="control-label" style="font-size:18px;">Address: <b> {{ $profiles->address }} </b></p>
                                <p class="control-label" style="font-size:18px;">City: <b> {{ $profiles->city }} </b></p>
                                <p class="control-label" style="font-size:18px;">Phone# <b> {{ $profiles->phone }} </b></p>
