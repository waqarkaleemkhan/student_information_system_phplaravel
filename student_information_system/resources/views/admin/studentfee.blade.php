        ...
        <div id="container"> 
            ...
            <div id="wrapper">
                ...
                <div id="sidebar-wrapper" class="stretch-full-height">
                    <ul class="sidebar-nav">
                        ...
                        <li> 
                            ...
                            <ul class="nav nav-list collapse submenu" id="uiMenus">
                                <li><a href="#" class="active" style="color: #ffffff;">Student Fee</a></li>
                ...
                <div class="container">
                    ...
                    <div class="row">
                            <div class="col-md-4">
                            <legend><span><i class="icon-user"></i></span> Student Fees </legend>
                            </div>
                            <div class="col-md-4">
                            </div>
                            <div class="col-md-4">
                            <form method="POST" action="{{ url('/searchfeereg') }}">
                            {{csrf_field()}}
                                        <div class = "input-group">
                                            <input type = "search" name="search" class = "form-control" placeholder="Search by registration #." required>
                            ...
                            @if(count($sf) > 0)
                                @foreach($sf->all() as $s)
                                    <tr class="success">
                                        ...
                                        <td name="reg">{{ $s->reg }}</td>
                                        <td name="doj">{{ $s->doj }}</td>
                                        <td name="total_fee">{{ $s->total_fee }}</td>
                                        <td name="paid">{{ $s->paid }}</td>
                                        <td name="remain">{{ $s->remain }}</td>
                                        <td name="action">
                                            <a href='{{ url("admin/secondinstallment/{$s->id}") }}' class="label label-info">2nd Installment</a>
                                            <a href='{{ url("admin/deletestudentfee/{$s->id}") }}' class="label label-danger">Delete</a>
                                        </td>
                                    </tr>
                                @endforeach
                            @endif
