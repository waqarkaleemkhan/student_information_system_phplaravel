            ...
            <div id="wrapper">
                ...
                <br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <legend><span><i class="icon-file"></i> &nbsp;</span>Result Reporter</legend>
                        </div>
                        <div class="col-md-3">
                        </div>
                    </div>
                    ...
                    <form class="form-horizontal" method="POST" action="{{ url('admin/resultreportered') }}">
                            {{csrf_field()}}
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label for="checker" class="col-lg-3 control-label">Checker:</label>
                                            <div class="col-lg-9">
                                        ...
                                        <label for="fee_status" class="col-lg-3 control-label">Fee Status:</label>
                                            <div class="col-lg-9">
                                                <select class="form-control" name="fee_status" required>
                                                        ...
                                                        <option value="remain" >Remainings</option>
                                                </select>
                                            </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="course_group" class="col-lg-3 control-label">Choose Course:</label>
                                            <div class="col-lg-9">
                                            <select class="form-control" name="course_group" required>
                                    ...
                                    <div class="form-group">
                                        <label for="grades" class="col-lg-3 control-label">Grade:</label>
                                            <div class="col-lg-9">
                                    ...
                                    <div class="form-group">
                                        <label for="sortby" class="col-lg-3 control-label">Sort By:</label>
                                            <div class="col-lg-9">
