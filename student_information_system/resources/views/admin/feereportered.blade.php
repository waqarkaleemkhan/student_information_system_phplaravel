            ...
            <div id="wrapper">
                ...
                <div class="container">
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-4">
                            <legend><span><i class="icon-user"></i></span> Student Fee Reports </legend>
                            </div>
                            <div class="col-md-4">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                        <p class="control-label" style="font-size:16px;"> Fee Status: <b>{{ $data['fee_status'] }}</b> </p>
                        </div>
                        <div class="col-md-4">
                        <p class="control-label" style="font-size:16px;"> Sort By: <b>{{ $data['sort'] }} (registration#)</b> </p>
                        </div>
                        <div class="col-md-4">
                        <p class="control-label" style="font-size:16px;"> Total No of Students: <b>{{ count($studfeedetails) }}</b> </p>
                        </div>
                    </div>
                    ...
                    <br>
                        ...
                        <thead>
                            <tr>
                                <th for="reg">Registration No.</th>
                                <th for="name">Name</th>
                                <th for="tf">Total Fee</th>
                                <th for="p">Paid</th>
                        ...
                        <tbody>
                        @foreach($studfeedetails as $studfee2)
                            
                            <tr class="warning">
                                <td name="reg">{{ $studfee2['reg'] }}</td>
                                <td name="name">{{ $studfee2['name'] }}</td>
                                <td name="tf">{{ $studfee2['total_fee'] }}</td>
                                <td name="p">{{ $studfee2['paid'] }}</td>
                                <td name="remain">{{ $studfee2['remain'] }}</td>
                                <td name="action">
                                    <a href='{{ url("admin/readcourses/{$studfee2["id"]}") }}' class="label label-primary">View Courses</a>
                                </td>
