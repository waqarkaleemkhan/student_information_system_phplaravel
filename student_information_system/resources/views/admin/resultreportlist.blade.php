            ...
            <div id="wrapper">
                ...
                <div class="container">
                    ...
                    <br>
                        ...
                        <tbody>
                        @foreach($studresults as $studresults2)
                            
                                    <tr class="success">
                                        <td name="id">{{ $studresults2['id'] }}</td>
                                        <td name="name">{{ $studresults2['name'] }}</td>
                                        <td name="reg">{{ $studresults2['reg'] }}</td>
                                        <td name="action">
                                            <a href='{{ url("admin/readresults/{$studresults2["id"]}") }}' class="label label-primary">View Results</a>
                                        </td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <p class="control-label" style="font-size:18px;">Total No of Results: <b> <u> {{ count($studresults) }} </u> </b> </p>
                            </div>
                            <div class="col-md-4">
                            </div>
