    ...
    <body>
        ...
        <div id="container"> 
            ...
            <div id="wrapper">
                ...
                <div id="sidebar-wrapper" class="stretch-full-height">
                    <ul class="sidebar-nav">
                        ...
                        <li> 
                            ...
                            <ul class="nav nav-list collapse submenu" id="uiMenus">
                                <li><a href="#" class="active" style="color: #ffffff;">Manage Course</a></li>
                ...
                <div class="container">
                    <div class="row">
                        <legend><span><i class="icon-books"></i></span> Courses </legend>
                        ...
                        <thead>
                            <tr>
                                <th for="id">#</th>
                                <th for="course_title">Course_Title</th>
                                <th for="code">Code</th>
                                <th for="cr_hrs">Cr_Hrs.</th>
                                <th for="semester">Semester</th>
                                <th for="program">Program</th>
                                <th for="session_name">Session_Name</th>
                        ...
                        <tbody>
                            @if(count($courses) > 0)
                                @foreach($courses->all() as $course)
                                    <tr class="success">
                                        <td name="id">{{ $course->course_id }}</td>
                                        <td name="course_title">{{ $course->course_title }}</td>
                                        <td name="code">{{ $course->code }}</td>
                                        <td name="cr_hrs">{{ $course->cr_hrs }}</td>
                                        <td name="semester">{{ $course->semester_id }}</td>
                                        <td name="program">{{ $course->program }}</td>
                                        <td name="session_name">{{ $course->session_name }}</td>
                                        <td name="action">
                                            <a href='{{ url("admin/editcourse/{$course->course_id}") }}' class="label label-primary">Edit</a>
                                            <a href='{{ url("admin/dropcourse/{$course->course_id}") }}' class="label label-danger">Drop</a>
                                        </td>
                                    </tr>
                                @endforeach
                            @endif
