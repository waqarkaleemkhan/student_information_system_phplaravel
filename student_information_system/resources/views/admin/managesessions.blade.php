    ...
    <body>
        ...
        <div id="container"> 
            ...
            <div id="wrapper">
                ...
                <div id="sidebar-wrapper" class="stretch-full-height">
                    <ul class="sidebar-nav">
                        ...
                        <li> 
                            ...
                            <ul class="nav nav-list collapse submenu" id="uiMenus">
                                <li><a href="#" class="active" style="color: #ffffff;">Manage Sessions</a></li>
                ...
                <div class="container">
                    <div class="row">
                        <legend><span><i class="icon-time"></i></span> Sessions </legend>
                        ...
                        <thead>
                            <tr>
                                <th for="id">ID</th>
                                <th for="session">Session</th>
                                <th for="c_due">Course Duedate</th>
                                <th for="f_due">Fees Duedate</th>
                                <th for="i_due">2nd Installment Duedate</th>
                                <th for="e_d">Exam Held In</th>
                        ...
                        <tbody>
                            @if(count($sessions) > 0)
                                @foreach($sessions->all() as $session)
                                    <tr class="success">
                                        <td name="id">{{ $session->id }}</td>
                                        <td name="session">{{ $session->session_name }}</td>
                                        <td name="c_due">{{ $session->course_duedate }}</td>
                                        <td name="f_due">{{ $session->fee_duedate }}</td>
                                        <td name="i_due">{{ $session->instal_duedate }}</td>
                                        <td name="e_d">{{ $session->exam_date }}</td>
                                        <td name="action">
                                            <a href='{{ url("admin/sessioncourse/{$session->session_name}") }}' class="label label-primary">Courses</a>
                                            <a href='{{ url("admin/deletesession/{$session->id}") }}' class="label label-danger">Delete</a>
                                        </td>
                                    </tr>
                                @endforeach
                            @endif
