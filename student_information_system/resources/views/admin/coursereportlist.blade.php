            ...
            <div id="wrapper">
                ...
                <div class="container">
                    ...
                    <br>
                        ...
                        <tbody>
                        @foreach($studcourses as $studcourses2)
                            
                                    <tr class="success">
                                        <td name="id">{{ $studcourses2['id'] }}</td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <p class="control-label" style="font-size:18px;">Total No of Students: <b> <u> {{ count($studcourses) }} </u> </b> </p>
                            </div>
                            <div class="col-md-4">
                            </div>
