        ...
        <div id="container"> 
            ...
            <div id="wrapper">
                    ...
                    <ul class="sidebar-nav">
                        ...
                        <li> 
                            ...
                            <ul class="nav nav-list collapse submenu" id="uiMenus">
                                ...
                                <li><a href="#" style="color: #ffffff;" class="active">Add Course</a></li>
                        ...
                        <li> 
                            ...
                            <ul class="nav nav-list collapse submenu" id="uiMenus">
                                <li><a href="{{ url('admin/feedetails') }}" style="color: #ffffff;">Fees Details</a></li>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <form class="form-horizontal" method="POST" action="{{ url('admin/addedcourse') }}">
                            {{csrf_field()}}
                            <legend class="text-center">Create a new Course</legend>
                                ...
                                <div class="col-md-6">
                                    <div class="panel panel-info">
                                        <div class="panel-heading">
                                            <div class="pull-left"><h4>Add Course</h4></div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-10">
                                                <input type="number" name="cr_hrs" class="form-control" required>
                                            </div>
                                            <div class="col-md-2"></div>
                                        </div>
