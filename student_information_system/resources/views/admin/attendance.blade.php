    ...
    <body>
        ...
        <div id="container"> 
            ...
            <div id="wrapper">
                ...
                <div class="container">
                    <div class="row">
                        <legend><span><i class="icon-user"></i></span> Student Attendance </legend>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th for="name">Name</th>
                                <th for="reg">Reg</th>
                                <th for="attend">Attendance Status</th>
                                <th for="action">Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            @if(count($attend) > 0)
                                @foreach($attend->all() as $a)
                                    <tr class="success">
                                        <td name="id">{{ $a->id }}</td>
                                        <td name="name">{{ $a->name }}</td>
                                        <td name="reg">{{ $a->reg }}</td>
                                        <td name="attend">{{ $a->attend_perc }}</td>
                                        <td name="action">
                                            <a href='{{ url("admin/deleteattendance/{$a->id}") }}' class="label label-danger">Delete</a>
                                        </td>
                                    </tr>
                                @endforeach
                            @endif
                ...
                <div class="container">
                    <div class="row text-center">
                        <a href='{{ url("admin/addattendance") }}' class="btn btn-primary btn-small">Add Attendance</a>
                    </div>
                </div>
