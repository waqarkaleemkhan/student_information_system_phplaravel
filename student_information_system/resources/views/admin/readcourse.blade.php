            ...
            <div id="wrapper">
                ...
                <div class="container">
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-4">
                            <legend><span><i class="icon-user"></i></span> Student Course Details </legend>
                            </div>
                            <div class="col-md-4">
                            </div>
                        </div>
                    ...
                    <br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <p class="control-label" style="font-size:18px;">Total no of courses registered in current semester: <b> <u> {{ count($cr) }} </u> </b> </p>
                            </div>
                            <div class="col-md-3">
                            </div>
