            ...
            <div id="wrapper">
                ...
                <div class="container">
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-4">
                            <legend><span><i class="icon-user"></i></span> Student Result Reports </legend>
                            </div>
                            <div class="col-md-4">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                        <p class="control-label" style="font-size:16px;"> Course Group: <b>{{ $data['course_group'] }}</b> </p>
                        </div>
                        <div class="col-md-4">
                        <p class="control-label" style="font-size:16px;"> Sort By: <b>{{ $data['sortby'] }}</b> </p>
                        </div>
                        <div class="col-md-4">
                        <p class="control-label" style="font-size:16px;"> Sort: <b>{{ $data['sort'] }}</b> </p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                        <p class="control-label" style="font-size:16px;"> Grades <b>{{ $data['checker'] }} {{ $data['grades'] }}</b> </p>
                        </div>
                        <div class="col-md-4">
                        <p class="control-label" style="font-size:16px;"> Total No of Students: <b>{{ count($profiles) }}</b> </p>
                        </div>
                    </div>
                    ...
                    <br>
                        ...
                        @foreach($profiles as $profile)
                            ...
                            <tr class="warning">
                                ...
                                <td name="action">
                                <a href='{{ url("admin/readresults/{$profile->id}") }}' class="label label-primary">View Results</a>
                                </td>
