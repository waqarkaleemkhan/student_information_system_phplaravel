        ...
        <div id="container"> 
            ...
            <div id="wrapper">
                ...
                <div id="page-content-wrapper" class="stretch-full-height animated-med-delay fadeInRight">
                    ...
                    <div class="row">
                    <legend class="panel panel-info text-center"><a href='{{ url("/editbystud")}}' class="label label-primary pull-left">Edit Profile</a> <i class="icon-user icon-1x"></i>&nbsp;Your Profile<a href='{{ url("/changepasswordstud")}}' class="label label-success pull-right">Change Password</a></legend>
                        ...
                        <div class="panel-body panel-collapse collapse in">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <p class="control-label" style="font-size:18px;">Address: <b>{{Auth::user()->address}}</b></p>
                                    <p class="control-label" style="font-size:18px;">City: <b>{{Auth::user()->city}}</b></p>
                                    <p class="control-label" style="font-size:18px;">Phone: <b>{{Auth::user()->phone}}</b></p>
