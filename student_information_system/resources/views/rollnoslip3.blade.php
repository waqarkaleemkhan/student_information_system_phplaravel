                            ...
                            <div class="center-panel col-sm-6 col-sm-offset-3 col-xs-offset-1">
                                <div class="text-center animated fadeInDown">
                                    <ul class="list-unstyled">
                                        <li class="text-transparent padding-bottom animated shake"><div class="huge-text">Roll#</div></li>
                                        <li>
                                            <h2 class="text-center">Please pay your full fee 1st.<br> If you paid than wait for end of classes. Thanks!</h2>
                                    </li>
                                    </ul>
                                </div>
                            </div>
