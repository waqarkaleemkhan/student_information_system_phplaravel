                            ...
                            <div class="center-panel col-sm-6 col-sm-offset-3 col-xs-offset-1">
                                <div class="text-center animated fadeInDown">
                                    <ul class="list-unstyled">
                                        <li class="text-transparent padding-bottom animated shake"><div class="huge-text">Sorry</div></li>
                                        <li>
                                            <h2 class="text-center">You are Prevent. Your attendance is less than 75%. <br> Please take your roll no slip from program office.</h2>
                                    </li>
                                    </ul>
                                </div>
                            </div>
