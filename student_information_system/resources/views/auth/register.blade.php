                             ...
                             {{ csrf_field() }}
                                ...
                                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                    ...
                                    <div class="input-group">
                                     		 <span class="input-group-btn">
                                      		 ...
                                      		 <input id="name" type="text" name="name" class="form-control" placeholder="Your First Name" value="{{ old('name') }}"  required autofocus>
                                    	</div><!-- /input-group -->
                                        @if ($errors->has('name'))
                                ...
                                <div class="form-group{{ $errors->has('lastname') ? ' has-error' : '' }}">
                                    ...
                                    <div class="input-group">
                                            ...
                                            <input id="lastname" type="text" name="lastname" class="form-control" placeholder="Your Last Name" value="{{ old('lastname') }}"  required autofocus>
                                        </div><!-- /input-group -->
