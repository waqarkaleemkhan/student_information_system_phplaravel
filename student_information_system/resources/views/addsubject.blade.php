        ...
        <div id="container"> 
            ...
            <div id="wrapper">
                ...
                <div id="page-content-wrapper" class="stretch-full-height animated-med-delay fadeInRight">
                    ...
                    <div class="container">
                        <div class="row">
                            <form class="form-horizontal" method="POST" action="{{ url('/addedsubject') }}">
                                {{csrf_field()}}
                                ...
                                <div class="col-md-12"></div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="panel panel-info">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <label for="course_title"><h4>Courses:</h4></label>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    @if(count($courses) > 0)
                                                        @foreach($courses->all() as $course)
                                                            <option value="{{ $course->course_title }}" selected="selected">{{ $course->course_title }}</option>
                                                        @endforeach
                                                    @endif
                                                    </select>
                                                </div>
